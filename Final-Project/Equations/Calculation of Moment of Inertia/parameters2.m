function [ q, Jr ] = parameters2(varargin)
    ...
    l(6) = 0.129*H*0;                   % Shoulder
    l(7) = 0.186*H;                     % Upper Arm 
    l(8) = 0.146*H ;                    % Forearm
    l(9) = 0.108*H;                     % Hand
    ...
    m(6) = 0;         % Mass of shoulder (Fix mass = 0  for now)
    m(7) = 0.028*M;   % Mass of upper arm
    m(8) = 0.016*M;   % Mass of forearm
    m(9) = 0.006*M;   % Mass of Hand
    ...
    cm(6) = 0.712*l(6);    % Center of Mass - Shoulder
    cm(7) = 0.436*l(7);    % Center of Mass - Upper Arm
    cm(8) = 0.430*l(8);    % Center of Mass - Forearm
    cm(9) = 0.506*l(9);    % Center of Mass - Hand
    ...
    rog(4) = 0.323;   % Thigh
    rog(5) = 0.496;   % HAT
    rog(6) = 0;       % Shoulder (Fix mass = 0  for now)
    rog(7) = 0.322;   % Upper Arm
    rog(8) = 0.303;   % Forearm 
    rog(9) = 0.297;   % Hand
    ...
    x6 = l(1)*cos(b1) + l(2)*cos(b2) + l(3)*cos(b3) + l(4)*cos(b4) + l(5)*cos(b5) + l(6)*cos(b6);
    y6 = l(1)*sin(b1) + l(2)*sin(b2) + l(3)*sin(b3) + l(4)*sin(b4) + l(5)*sin(b5) + l(6)*sin(b6);
    x7 = l(1)*cos(b1) + l(2)*cos(b2) + l(3)*cos(b3) + l(4)*cos(b4) + l(5)*cos(b5) + l(6)*cos(b6) + l(7)*cos(b7);
    y7 = l(1)*sin(b1) + l(2)*sin(b2) + l(3)*sin(b3) + l(4)*sin(b4) + l(5)*sin(b5) + l(6)*sin(b6) + l(7)*sin(b7);
    x8 = l(1)*cos(b1) + l(2)*cos(b2) + l(3)*cos(b3) + l(4)*cos(b4) + l(5)*cos(b5) + l(6)*cos(b6) + l(7)*cos(b7) + l(6)*cos(b8);
    y8 = l(1)*sin(b1) + l(2)*sin(b2) + l(3)*sin(b3) + l(4)*sin(b4) + l(5)*sin(b5) + l(6)*sin(b6) + l(7)*sin(b7) + l(6)*sin(b8);
    x9 = l(1)*cos(b1) + l(2)*cos(b2) + l(3)*cos(b3) + l(4)*cos(b4) + l(5)*cos(b5) + l(6)*cos(b6) + l(7)*cos(b7) + l(6)*cos(b8) + l(7)*cos(b9);
    y9 = l(1)*sin(b1) + l(2)*sin(b2) + l(3)*sin(b3) + l(4)*sin(b4) + l(5)*sin(b5) + l(6)*sin(b6) + l(7)*sin(b7) + l(6)*sin(b8) + l(7)*sin(b9);
    ...
    cx5 = l(1)*cos(b1) + l(2)*cos(b2) + l(3)*cos(b3) + l(4)*cos(b4) + (l(5)-cm(5))*cos(b5);
    cy5 = l(1)*sin(b1) + l(2)*sin(b2) + l(3)*sin(b3) + l(4)*sin(b4) + (l(5)-cm(5))*sin(b5);
    cx6 = l(1)*cos(b1) + l(2)*cos(b2) + l(3)*cos(b3) + l(4)*cos(b4) + l(5)*cos(b5) + (l(6)-cm(6))*cos(b6);
    cy6 = l(1)*sin(b1) + l(2)*sin(b2) + l(3)*sin(b3) + l(4)*sin(b4) + l(5)*sin(b5) + (l(6)-cm(6))*sin(b6);
    cx7 = l(1)*cos(b1) + l(2)*cos(b2) + l(3)*cos(b3) + l(4)*cos(b4) + l(5)*cos(b5) + l(6)*cos(b6) + (l(7)-cm(7))*cos(b7);
    cy7 = l(1)*sin(b1) + l(2)*sin(b2) + l(3)*sin(b3) + l(4)*sin(b4) + l(5)*sin(b5) + l(6)*sin(b6) + (l(7)-cm(7))*sin(b7);
    cx8 = l(1)*cos(b1) + l(2)*cos(b2) + l(3)*cos(b3) + l(4)*cos(b4) + l(5)*cos(b5) + l(6)*cos(b6) + l(7)*cos(b7) + (l(8)-cm(8))*cos(b8);
    cy8 = l(1)*sin(b1) + l(2)*sin(b2) + l(3)*sin(b3) + l(4)*sin(b4) + l(5)*sin(b5) + l(6)*sin(b6) + l(7)*sin(b7) + (l(8)-cm(8))*sin(b8);
    cx9 = l(1)*cos(b1) + l(2)*cos(b2) + l(3)*cos(b3) + l(4)*cos(b4) + l(5)*cos(b5) + l(6)*cos(b6) + l(7)*cos(b7) + l(8)*cos(b8) + cm(9)*cos(b9);
    cy9 = l(1)*sin(b1) + l(2)*sin(b2) + l(3)*sin(b3) + l(4)*sin(b4) + l(5)*sin(b5) + l(6)*sin(b6) + l(7)*sin(b7) + l(8)*sin(b8) + cm(9)*sin(b9);
    ...
    % Center of Mass of the Patient ---------------------------------------
    CMpx = 0; CMpy = 0; Mt = 0;
    for i=1:5
        if i<5                          % hand, forearm, upper arm (2X)
    ...
    % Plots ---------------------------------------------------------------
    fig = figure; fig.Renderer = 'Painters'; hold on; box on;
